...
├── experiments/
│   └── prime113/            # Prime-order DLP control experiments
├── results/
...
The manuscript is archived on Zenodo as a non-peer-reviewed preprint:

**DOI:** https://doi.org/10.5281/zenodo.22813397
